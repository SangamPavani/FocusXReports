...
public class ExcelNew {
	...
	public static class KW
	{
	    public static void main(String[] args)
	    {
	        try
	        {
	            FileInputStream excellFile1 = new FileInputStream(new File("E:\\FocusSanityReports\\FocusAI\\autoIt\\ExportFiles\\TrialBalancePlainExcelSheet.xlsx"));
	            FileInputStream excellFile2 = new FileInputStream(new File("E:\\FocusSanityReports\\FocusAI\\autoIt\\ImportFiles\\TrialBalancePlainExcelSheet.xlsx"));
